...
class _VewReportScreenState extends State<VewReportScreen> {
  final List<String> _mapList = ["All","Google Maps", "Apple Maps", "Bing Maps", "OpenStreetMap"];
  String? _selectedMap; // Variable to store the selected map

  final List<String> _shiftList = ["All","A", "B", "C", "D"];
                ...
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: DataTable(
                        headingRowColor: WidgetStateColor.resolveWith((states) => Colors.grey.shade100), // Title row color
                        dataRowColor: WidgetStateColor.resolveWith((states) => Colors.white), // Data row color
                        //columnSpacing: 10,
                        columnSpacing: 10,
                        columns: const [
                          DataColumn(
